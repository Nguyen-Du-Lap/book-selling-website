...
public class FeeGHNUtils {
	...
	public static String registerShip(int height, int lenght, int with,int weght,int  from_district_id, int from_ward_id,String tenHuyen, String tenXa) {
...
//	public static String dangki()  {
//		try {
//			HttpClient httpClient = HttpClients.createDefault();
//			HttpPost httpPost = new HttpPost("http://140.238.54.136/api/auth/register");
//
//			List<NameValuePair> params = new ArrayList<>();
//			params.add(new BasicNameValuePair("name", "TranTien"));
//			params.add(new BasicNameValuePair("email", "sosinhsv1b@gmail.com"));
//			params.add(new BasicNameValuePair("password", "123456"));
//			params.add(new BasicNameValuePair("password_confirmation", "123456"));
//
//			httpPost.setEntity(new UrlEncodedFormEntity(params));
//			httpPost.setHeader(HttpHeaders.CONTENT_TYPE, "application/x-www-form-urlencoded");
//
...
//	}
	...
	public static void main(String[] args) {
		System.out.println(registerShip(100,100,100,100,1463,21808,"Huyện Văn Yên","Xã Yên Thái"));
	}
