...
public class FeeGHNUtils {
	...
	public static ArrayList<String> registerShip(int height, int lenght, int with,int weght,int  from_district_id, int from_ward_id,String tenHuyen, String tenXa) {
	...
	public static void main(String[] args) {
		System.out.println(getDateShip(10,10,13,200,2264,90816,"Quận Thủ Đức","Phường Linh Trung"));
	}
