...
public class GoogleConstant {
	  ...
	  public static String GOOGLE_CLIENT_SECRET = "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";
	  public static String GOOGLE_REDIRECT_URI = "http://localhost:8080/book_selling_website/login-google";
