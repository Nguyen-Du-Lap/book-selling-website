                ...
                <div class="tile-body">
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            ...
                            <td>12345678</td>
                            <td>Tịnh Sơn - Sơn Tịnh - Quảng Ngãi</td>
                            <td>0932766789</td>
                            <td>15/09/2017</td>
                            <td>1</td>
                        ...
                        <tr>
                            ...
                            <td>12345678</td>
                            <td>Phường Yên Hòa - Quận Cầu Giấy</td>
                            <td>0127856567</td>
                            <td>05/05/2021</td>
                            <td>2</td>
                            <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
            ...
            <h5>Chỉnh sửa thông tin nhân viên cơ bản</h5>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="number" value="0000001">
                    </div>
                    <div class="form-group col-md-6">
                        <label class="control-label">Họ</label>
                        <input class="form-control" type="text" required value="Nguyễn">
                    </div>
                    <div class="form-group  col-md-6">
                        <label class="control-label">Tên</label>
                        <input class="form-control" type="text" required value="Uyên Thư">
                    </div>
                    <div class="form-group col-md-6 ">
                        <label for="exampleSelect1" class="control-label">Trạng thái hoạt động</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="text" value="uyenthu@gmail.com">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleSelect1" class="control-label">Số điện thoại</label>
                        <input class="form-control" type="number" value="0932766789">
                    </div>
                </div>
                <BR>
                <a href="#" style="    float: right;
    font-weight: 600;
    color: #ea0000;">Chỉnh sửa thông tin nhân viên nâng cao</a>
                <BR>
                <BR>
