...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/templates/styles/Contact.css">
  ...
  <div class="container">
    ...
    <div class="content_container">
      ...
      <div class="content_right">
        <form form action="${pageContext.request.contextPath}/contact" id="submit_form" method="post">
