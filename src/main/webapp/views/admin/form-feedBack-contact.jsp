...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Phản hồi người dùng</h3>
                    <div class="col-sm-6">
                    ...
                    <form action="/findContact"  method="post" class="row">
                        ...
                        <div class="form-group col-md-9">
                            <p class="form-control" name="content" rows="10" cols="20" id="note1"
                                      placeholder="Nội dung">${contact.content}</p>
                        </div>
                        <div class="form-group col-md-9">
                            <textarea class="form-control" name="contentFeedBack" rows="10" cols="20" id="note"
                                      placeholder="Nội dung phản hồi khách hàng"></textarea>
                        </div>

                        <div class="form-group col-md-9">
                            <button class="btn btn-save" type="submit">Gửi</button>
                            <a class="btn btn-cancel" href="${pageContext.request.contextPath}/admin-management-contact">Hủy bỏ</a>
                        </div>
                    </form>
                </div>
            </div>
