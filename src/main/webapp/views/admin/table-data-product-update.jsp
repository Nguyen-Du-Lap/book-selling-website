    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="${pageContext.request.contextPath}/update-book" enctype="multipart/form-data" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <c:forEach var="book" items="${bookUpdate}">
                            <div class="form-group col-md-6">
                                <label class="control-label">Mã sản phẩm </label>
                                <input name="id" class="form-control" type="text" value="${book.id}">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">Tên sản phẩm</label>
                                <input name="name" class="form-control" type="text" required value="${book.name}">
                            </div>
                            <div class="form-group  col-md-6">
                                <label class="control-label">Số lượng</label>
                                <input name="quantity" class="form-control" type="number" required value="${book.quantity}">
                            </div>
                            <div class="form-group col-md-6 ">
                                <label  class="control-label">Tình trạng sản phẩm</label>
                                <select name="status" class="form-control" id="exampleSel1">
                                    <c:if test="${book.status == 'Còn hàng'}">
                                        <option selected>Còn hàng</option>
                                        <option>Hết hàng</option>
                                        <option>Đang nhập hàng</option>
                                    </c:if>
                                    <c:if test="${book.status == 'Hết hàng'}">
                                        <option>Còn hàng</option>
                                        <option selected>Hết hàng</option>
                                        <option>Đang nhập hàng</option>
                                    </c:if>
                                    <c:if test="${book.status == 'Đang nhập hàng'}">
                                        <option>Còn hàng</option>
                                        <option>Hết hàng</option>
                                        <option selected>Đang nhập hàng</option>
                                    </c:if>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="price" class="form-control" type="text" value="${book.price}">
                            </div>
                            <div class="form-group  col-md-6">
